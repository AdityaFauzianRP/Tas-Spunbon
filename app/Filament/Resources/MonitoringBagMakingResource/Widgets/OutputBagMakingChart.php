...
namespace App\Filament\Resources\MonitoringBagMakingResource\Widgets;

use App\Models\MesinJadwal;
use Filament\Widgets\LineChartWidget;
use Carbon\Carbon;

class OutputBagMakingChart extends LineChartWidget
{
    ...
    protected function getData(): array
    {
        $data = MesinJadwal::query()
            ...
            ->where('mesin.nama_mesin', '=', 'BagMaking')
